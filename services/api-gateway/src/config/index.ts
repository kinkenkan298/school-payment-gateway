...
const envSchema = z.object({
  ...
  TRANSACTION_SERVICE_URL: z.url().default('http://localhost:3004'),
  NOTIFICATION_SERVICE_URL: z.url().default('http://localhost:3005'),
  SETTLEMENT_SERVICE_URL: z.url().default('http://localhost:3006'),
  FRAUD_DETECTION_URL: z.url().default('http://localhost:3007'),
